...
use Integra\Domain\Integration\Promo\Operation\Bet\Data\BetResultTurnoverDataBuilder;
...
class BetResultTurnoverPromoHandler extends AbstractPromoOperationHandler
{
    private BetResultTurnoverDataBuilder $builder;

    public function __construct(Transport $transport)
    {
        parent::__construct($transport);
        $this->builder = new BetResultTurnoverDataBuilder();
    }
