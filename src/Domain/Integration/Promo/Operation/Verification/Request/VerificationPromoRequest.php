...
namespace Integra\Domain\Integration\Promo\Operation\Verification\Request;
...
class VerificationPromoRequest extends AbstractRequest implements RequestInterface
{
    /**
     * @return Method
     */
