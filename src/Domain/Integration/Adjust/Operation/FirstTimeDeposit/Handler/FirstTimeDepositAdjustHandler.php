...
use Integra\Domain\Integration\Adjust\Operation\FirstTimeDeposit\Data\FirstTimeDepositAdjustDataBuilder;
...
final class FirstTimeDepositAdjustHandler extends AbstractAdjustOperationHandler
{
    private FirstTimeDepositAdjustDataBuilder $builder;

    public function __construct(protected readonly Transport $transport)
    {
        parent::__construct($transport);
        $this->builder = new FirstTimeDepositAdjustDataBuilder();
    }
    ...
    protected function buildConfig(array $raw): IntegrationConfigInterface
    {
        ...
        $event = match ($platform) {
            PlatformNameEnum::ANDROID => S2SEventEnum::FTD_ANDROID,
            PlatformNameEnum::IOS => S2SEventEnum::FTD_IOS,
