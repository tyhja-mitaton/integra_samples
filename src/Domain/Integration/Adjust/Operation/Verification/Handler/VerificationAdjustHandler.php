...
namespace Integra\Domain\Integration\Adjust\Operation\Verification\Handler;
...
use Integra\Domain\Integration\Adjust\Operation\Verification\Data\VerificationAdjustDataBuilder;
use Integra\Domain\Integration\Adjust\Operation\Verification\Request\VerificationAdjustRequest;
...
class VerificationAdjustHandler extends AbstractAdjustOperationHandler
{
    private VerificationAdjustDataBuilder $builder;

    public function __construct(protected readonly Transport $transport)
    {
        parent::__construct($transport);
        $this->builder = new VerificationAdjustDataBuilder();
    }
    ...
    protected function buildConfig(array $raw): IntegrationConfigInterface
    {
        ...
        $event = match ($platform) {
            PlatformNameEnum::ANDROID => S2SEventEnum::VERIFICATION_ANDROID,
            PlatformNameEnum::IOS => S2SEventEnum::VERIFICATION_IOS,
    ...
    {
        return new VerificationAdjustRequest(
            dto: $dto,
            config: $config
        );
    }
