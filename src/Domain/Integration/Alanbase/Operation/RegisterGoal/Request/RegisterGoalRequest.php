...
namespace Integra\Domain\Integration\Alanbase\Operation\RegisterLead\Request;
...
final class RegisterGoalRequest extends AbstractRequest implements RequestInterface
{
    /**
     * @return Method
     */
