...
namespace Integra\Domain\Integration\Alanbase\Operation\BetBonusFee\Request;
...
class BetBonusFeeRequest extends AbstractRequest implements RequestInterface
{
    /**
     * @inheritDoc
     */
