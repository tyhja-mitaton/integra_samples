...
use Integra\Domain\Integration\Alanbase\Operation\BetNew\Data\BetMiniGameDataBuilder;
...
class BetMiniGameHandler extends AbstractAlanbaseOperationHandler
{
    protected BetMiniGameDataBuilder $builder;

    public function __construct(Transport $transport)
    {
        parent::__construct($transport);
        $this->builder = new BetMiniGameDataBuilder();
    }
