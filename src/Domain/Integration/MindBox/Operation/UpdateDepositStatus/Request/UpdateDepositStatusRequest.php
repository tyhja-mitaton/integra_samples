...
namespace Integra\Domain\Integration\MindBox\Operation\UpdateDepositStatus\Request;
...
class UpdateDepositStatusRequest extends AbstractRequest implements RequestInterface
{
    /**
     * @return Method
     */
