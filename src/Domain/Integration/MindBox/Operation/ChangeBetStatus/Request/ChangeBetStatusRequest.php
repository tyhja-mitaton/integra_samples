...
namespace Integra\Domain\Integration\MindBox\Operation\ChangeBetStatus\Request;
...
class ChangeBetStatusRequest extends AbstractRequest implements RequestInterface
{
    /**
     * @inheritDoc
     */
