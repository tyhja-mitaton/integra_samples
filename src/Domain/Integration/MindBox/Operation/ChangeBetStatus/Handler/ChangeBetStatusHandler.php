...
use Integra\Domain\Integration\MindBox\Operation\ChangeBetStatus\Data\ChangeBetStatusDataBuilder;
use Integra\Domain\Integration\MindBox\Operation\ChangeBetStatus\Request\ChangeBetStatusRequest;
use Integra\Infrastructure\Http\Transport;

class ChangeBetStatusHandler extends AbstractMindBoxOperationHandler
{
    private ChangeBetStatusDataBuilder $builder;
    ...
    )
    {
        ...
        $this->builder = new ChangeBetStatusDataBuilder();
    }
