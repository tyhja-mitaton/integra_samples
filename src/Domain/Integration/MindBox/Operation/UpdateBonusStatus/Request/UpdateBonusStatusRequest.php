...
namespace Integra\Domain\Integration\MindBox\Operation\UpdateBonusStatus\Request;
...
class UpdateBonusStatusRequest extends AbstractRequest implements RequestInterface
{
    /**
     * @inheritDoc
     */
