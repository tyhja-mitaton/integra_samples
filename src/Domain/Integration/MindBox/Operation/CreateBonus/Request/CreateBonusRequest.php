...
namespace Integra\Domain\Integration\MindBox\Operation\CreateBonus\Request;
...
class CreateBonusRequest extends AbstractRequest implements RequestInterface
{
    /**
     * @inheritDoc
     */
