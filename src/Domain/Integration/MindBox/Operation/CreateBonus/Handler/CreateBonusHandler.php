...
namespace Integra\Domain\Integration\MindBox\Operation\CreateBonus\Handler;
...
use Integra\Domain\Integration\MindBox\Operation\CreateBonus\Data\CreateBonusDataBuilder;
use Integra\Domain\Integration\MindBox\Operation\CreateBonus\Request\CreateBonusRequest;
use Integra\Infrastructure\Http\Transport;

class CreateBonusHandler extends AbstractMindBoxOperationHandler
{
    private CreateBonusDataBuilder $builder;

    public function __construct(
        Transport                    $transport
    ) {
        parent::__construct($transport);
        $this->builder = new CreateBonusDataBuilder();
    }
    ...
    protected function buildConfig(array $raw): IntegrationConfigInterface
    {
        ...
        return MindBoxConfig::create(
            MindBoxOperationNameEnum::CREATE_BONUS,
            null,
            $timeout,
        );
    }
    ...
    {
        return new CreateBonusRequest($dto, $config);
    }
}