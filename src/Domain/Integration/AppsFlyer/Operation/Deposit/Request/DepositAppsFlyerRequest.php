...
namespace Integra\Domain\Integration\AppsFlyer\Operation\Deposit\Request;
...
class DepositAppsFlyerRequest extends AbstractRequest implements RequestInterface
{
    /**
     * @inheritDoc
     */
    ...
    public function headers(): array
    {
        return [
            ...
            'Authentication: ' . $this->config->getAccessToken(),
