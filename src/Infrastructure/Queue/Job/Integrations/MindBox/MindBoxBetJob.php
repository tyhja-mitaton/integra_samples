...
use yii\queue\Queue;
use Yii;
use Integra\Domain\Integration\MindBox\Operation\CreateBet\Handler\CreateBetHandler;

class MindBoxBetJob extends AbstractIntegrationJob implements IntegrationJobInterface
{
