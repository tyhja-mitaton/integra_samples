...
use Integra\Domain\Integration\MindBox\Operation\SportExpertRegisterUser\Handler\SportExpertRegisterCustomerHandler;

class MindBoxRegistrationNationalSportExpertJob extends AbstractIntegrationJob implements IntegrationJobInterface
{
    public int $userId;
    ...
    {
        return new SportExpertRegisterCustomerHandler(
            $transport,
