...
use Integra\Domain\Integration\Promo\Operation\Email\Handler\EmailPromoHandler;
...
class PromoEmailJob extends AbstractIntegrationJob implements IntegrationJobInterface
{
    public int $userId;
