...
use Integra\Domain\Integration\Promo\Operation\Bet\Handler\BetResultTurnoverPromoHandler;
...
class PromoBetResultTurnoverJob extends AbstractIntegrationJob implements IntegrationJobInterface
{
    ...
    {
        return new BetResultTurnoverPromoHandler(
            $transport
        );
    }
}