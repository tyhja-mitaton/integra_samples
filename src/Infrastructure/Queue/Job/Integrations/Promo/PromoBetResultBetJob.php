...
use Integra\Domain\Integration\Promo\Operation\Bet\Handler\BetResultBetPromoHandler;
...
class PromoBetResultBetJob extends AbstractIntegrationJob implements IntegrationJobInterface
{
    public int $betId;
    ...
    {
        return new BetResultBetPromoHandler(
            $transport
        );
    }
}