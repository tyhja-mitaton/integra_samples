...
use Integra\Domain\Integration\Promo\Operation\NewStatus\Handler\NewStatusPromoHandler;
...
class PromoNewStatusJob extends AbstractIntegrationJob implements IntegrationJobInterface
{
    public int $userId;
    public int $statusId;
    ...
    {
        return new NewStatusPromoHandler(
            $transport
        );
    }
