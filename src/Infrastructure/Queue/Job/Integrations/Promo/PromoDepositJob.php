...
use Integra\Domain\Integration\Promo\Operation\Deposit\Handler\DepositPromoHandler;
...
class PromoDepositJob extends AbstractIntegrationJob implements IntegrationJobInterface
{
    public int $payId;
    ...
    {
        return new DepositPromoHandler(
            $transport
        );
    }
