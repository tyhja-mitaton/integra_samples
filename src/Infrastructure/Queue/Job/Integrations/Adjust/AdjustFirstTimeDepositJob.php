...
use Integra\Domain\Integration\Adjust\Operation\FirstTimeDeposit\Handler\FirstTimeDepositAdjustHandler;
...
class AdjustFirstTimeDepositJob extends AbstractIntegrationJob implements IntegrationJobInterface
{
    public int $userId;
    ...
    {
        return new FirstTimeDepositAdjustHandler($transport);
    }
}