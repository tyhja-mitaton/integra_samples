...
use Integra\Domain\Integration\Adjust\Operation\FirstTimeDeposit\Handler\RecurringDepositAdjustHandler;
...
class AdjustRecurringDepositJob extends AbstractIntegrationJob implements IntegrationJobInterface
{
    public int $userId;
    ...
    {
        return new RecurringDepositAdjustHandler(
            transport: $transport
        );
    }
