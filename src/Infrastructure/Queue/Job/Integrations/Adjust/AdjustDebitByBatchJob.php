...
use Integra\Domain\Integration\Adjust\Operation\Bet\Handler\DebitByBatchAdjustHandler;
...
class AdjustDebitByBatchJob extends AbstractIntegrationJob implements IntegrationJobInterface
{
    public int $userId;
    public int $betId;
    ...
    {
        return new DebitByBatchAdjustHandler(
            transport: $transport
        );
    }
