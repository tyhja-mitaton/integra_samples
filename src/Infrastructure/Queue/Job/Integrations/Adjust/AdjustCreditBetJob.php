...
use Integra\Domain\Integration\Adjust\Operation\Bet\Handler\CreditBetAdjustHandler;
...
class AdjustCreditBetJob extends AbstractIntegrationJob implements IntegrationJobInterface
{
    public int $userId;
    ...
    {
        return new CreditBetAdjustHandler(
            transport: $transport
        );
    }
