...
namespace Integra\UserStory\ExternalApplication\Affise\BetEvent\Request;
...
/**
 * Class BetEventRequest
 *
 * @package Integra\UserStory\ExternalApplication\Affise\BetEvent\Request
 */
class BetEventRequest implements Request
{
    /**
    ...
    public function url(): Url
    {
        return
            new FromString(
                sprintf(
                    '%s/v1/external_data/add_simple_event?affise_device_id=%s&p_price=%s&p_quantity=%s&p_revenue=%s&p_receipt_id=%s&p_currency=%s&event_name=%s&API-KEY=%s',
