...
namespace Integra\UserStory\ExternalApplication\Affise\DepositEvent\Validation;
...
/**
 * Class ValidatedDepositEventCommand
 *
 * @package Integra\UserStory\ExternalApplication\Affise\DepositEvent\Validation
 */
class ValidatedDepositEventCommand implements Validatable
{
    /**
